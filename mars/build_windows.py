...
WIN_GEN_PROJECT_CMD = 'cmake ../.. -G "Visual Studio 17 2022" -T v143'
SSL_ARCH = 'x86'
...
def build_windows_xlog(incremental: bool, tag: str = '', config: str = 'Release', lib_exe_path: str = ""):
    ...
    for lib in glob.glob(WIN_LIBS_INSTALL_PATH + '*.lib'):
        if os.path.normpath(lib) not in needed_libs:
            os.remove(lib)
...
def main():
    ...
    if "MSVC_BIN_HOST64_PATH" not in os.environ:
        DEFAULT_MSVC_BIN_HOST64_PATH = "C:/Program Files/Microsoft Visual Studio/2022/Community/VC/Tools/MSVC/14.39.33519/bin/Hostx64/"
    ...
    if "MSVC_TOOLS_PATH" not in os.environ:
        DEFAULT_MSVC_TOOLS_PATH = "C:/Program Files/Microsoft Visual Studio/2022/Community/Common7/Tools"
